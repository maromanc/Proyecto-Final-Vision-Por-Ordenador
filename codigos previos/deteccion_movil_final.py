...
while True:
    ...
    if not tracking:
        ...
        for cnt in contours:
            ...
            if 1.4 < ar < 2.5:
                ...
                cv2.putText(frame, "Movil detectado (inicio tracker)", (x, y-10),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0), 2)
                break

        if phone_detected:
            # =============================
            # INICIAR TRACKER CSRT
            # =============================
    ...
    # =============================
        ...
        if ok:
            ...
            # Tracker falló, móvil desapareció
            no_phone_frames += 1
        ...
        # Si el tracker falla pero aún no se alcanza threshold:
        if not ok:
            cv2.putText(frame, "Buscando desaparicion...", (20, 80),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,0,255), 2)

    # ==================================
    # MOSTRAR CONTADOR EN PANTALLA
    # ==================================
    cv2.putText(frame, f"Veces que coges el movil: {phone_count}",
                (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2)

    cv2.imshow("Tracker del movil rojo", frame)
